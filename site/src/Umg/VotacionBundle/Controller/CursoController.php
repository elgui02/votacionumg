...
class CursoController extends Controller
{
    ...
    {
        $dataTable = $this->get('data_tables.manager')->getTable('cursoTable');
     ...
     * @Method("POST")
     * @Template("UmgVotacionBundle:Curso:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UmgVotacionBundle:Curso')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("UmgVotacionBundle:Curso:edit.html.twig")
     */
